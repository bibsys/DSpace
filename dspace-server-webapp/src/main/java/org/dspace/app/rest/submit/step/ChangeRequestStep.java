...
/**
 * Section step class for the Change Request section. It searches for a change request value and returns it in a
 * DataChangeRequest form.
 * 
...
public class ChangeRequestStep extends AbstractProcessingStep {
    ...
    private MetadataField activeRF = new MetadataField(configService.getProperty(
