...
public class CanCreateSubmission implements AuthorizationFeature {
    ...
    public boolean isAuthorized(Context context, BaseObjectRest object) throws SQLException {
        ...
        if (currentUser != null) {
            for (Group group: currentUser.getGroups()) {
                ...
                // 2. - The user is a student that has no pending submissions
    ...
    */
     ...
     * 
     * @param propertyName A configuration property name to check values from.
    ...
    */
    private boolean isPresentForProperty(String propertyName, String searchedValue) {
        return Arrays.asList(configService.getArrayProperty(propertyName)).contains(searchedValue);
    }
