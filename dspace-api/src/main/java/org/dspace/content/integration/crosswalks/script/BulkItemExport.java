...
public class BulkItemExport extends DSpaceRunnable<BulkItemExportScriptConfiguration<BulkItemExport>> {
    ...
    /**
     * Build the file name for a bulk item export.
     * The export filename is generated by the configured crosswalk and may include
     * dynamic values such as the export date and crosswalk name.
     *
