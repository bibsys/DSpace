...
import org.dspace.discovery.SolrServiceResourceRestrictionPlugin;
...
public class MasterThesisServiceImpl implements MasterThesisService {
    ...
    public final Iterator<Item> search(Context context, Triple<String, Object, Boolean>... criteria)
        ...
        // We won't check the 'read' solr permissions for this search.
        // For ESB, we can check into any Item or submitted Item without restriction.
        discoverQuery.addDisabledPlugin(SolrServiceResourceRestrictionPlugin.class);
