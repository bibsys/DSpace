 ...
 * User can choose to automatically validate the user agreement license; or to disable it (if user has already
 * validated the license).
 *
 * USAGE:
 ...
 *   --disable: disable the user agreement (Next login attempt, the user should accept again the license)
 *
...
public class UserAgreementManagement extends AbstractCLICommand {
    ...
    public static final String USAGE_DESCRIPTION =
            "A command-line tool to automatically manage the user agreement for a user";
     ...
     * @param validation if true, the user agreement must be validated, otherwise the user agreement will be disabled
     * @throws SQLException if any exceptions occurred during the process.
     * @throws AuthorizeException if any authorization exceptions occurred during the process.
     */
