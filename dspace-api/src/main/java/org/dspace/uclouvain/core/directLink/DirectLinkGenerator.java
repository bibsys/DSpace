...
public abstract class DirectLinkGenerator {
     ...
     */
    protected abstract String buildSecret(Bitstream bitstream, Map<String, Object> args) throws Exception;
     ...
     */
    protected abstract boolean validateToken(Bitstream bitstream, String token);
     ...
     */
    protected abstract boolean validateBitstream(Bitstream bitstream, String token);
     ...
     */
    public String buildURL(Bitstream bitstream, Map<String, Object> args) throws Exception {
        return String.format(
            "%s/api/uclouvain/bitstream/%s/content?hash=%s",
            backendURL,
            bitstream.getID(),
            buildSecret(bitstream, args)
        );
    }
     ...
     */
    public boolean isTokenValid(Bitstream bitstream, String token) {
        return this.validateToken(bitstream, token) && this.validateBitstream(bitstream, token);
    }
