...
public abstract class GenericThesisEmail {
    ...
    protected static final Logger log = LogManager.getLogger(GenericThesisEmail.class);
    ...
    // CONSTRUCTORS ====================================================================================================
    protected GenericThesisEmail(Context context, Item item) {
    ...
    public void sendEmail() throws IOException, EmailGenerationException, MessagingException {
        ...
        generateEmail(email); // build email content and build additional arguments
        email.send();
    }
