...
/** 
 * Represents a response sent to Angular frontend app, and that can be used by dynamic fields
 * 
...
public class MetadataSelectFieldValuesGenerator {
    ...
    public boolean optionsPresent() {
        return !content.getOptions().isEmpty();
    }
    ...
    public class OSISStudentMetadataContent {
        ...
        private List<OSISStudentMetadataContentData> options = new ArrayList<>();
