...
public class GeneratePDFAction extends ProcessingAction {
    ...
    private String mailSubject = DSpaceServicesFactory
            .getInstance()
            .getConfigurationService()
            .getProperty("uclouvain.pdf_attestation.mail.subject");
    private String mailErrorSubject = DSpaceServicesFactory
            .getInstance()
            .getConfigurationService()
        ...
        try {
            ...
            if (handler != null) {
                ...
                try {
                    ...
                    email.addAttachment(
                            pdfAttestation,
                            map.get("dspace_entity_type").get(0) + "SubmissionAttestation.pdf", "application/pdf"
                    );
                    email.send();
                } catch (Exception e) {
            ...
            System.err.println("Error generating email attestation for uuid: " + uuid + ": " + e.getMessage());
    ...
    */
    private static String generateSubmissionResume(HashMap<String, List<String>> map) throws ResumeGenerationException {
        try {
            ...
            return "Title: " + title + "\nAuthor(s): " + authors.stream().reduce("", (subtotal, element) -> subtotal
